...
export type OrganizationCustomData = S.Schema.Type<typeof OrganizationCustomDataSchema>
...
export const toValidatedOrganization = (org: LogtoOrganizationRaw): ValidatedOrganization => ({
  ...org,
  customData: decodeCustomData(org.customData),
})

export const toValidatedOrganizations = (orgs: LogtoOrganizationRaw[]): ValidatedOrganization[] =>
  orgs.map(toValidatedOrganization)
