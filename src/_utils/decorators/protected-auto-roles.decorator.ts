...
import { UserRoleEnum, UserPermissionsEnum } from 'src/logto/_utils/enums/permissions.enum'
...
export function ProtectedAutoRolesDecorator(opts?: ProtectOptions): MethodDecorator & ClassDecorator {
  return (_target: object, _propertyKey?: string | symbol, descriptor?: PropertyDescriptor) => {
    if (!descriptor?.value || typeof descriptor.value !== 'function') {
      return
    }

    const existingMetadata = Reflect.getMetadata(DECORATORS.API_OPERATION, descriptor.value) as
