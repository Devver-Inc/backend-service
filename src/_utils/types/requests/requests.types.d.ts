...
export type CreateOrganizationBody = Omit<PathRequestBody<'/api/organizations', 'post'>['content']['application/json'], 'customData'> & {
    customData: OrganizationCustomData;
};
export type UpdateOrganizationBody = Omit<PathRequestBody<'/api/organizations/{id}', 'patch'>['content']['application/json'], 'customData'> & {
    customData?: OrganizationCustomData;
};
export {};
